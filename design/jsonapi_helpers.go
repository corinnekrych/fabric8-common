...
// RelationKindUUID is a top level structure for 'other' relationships
...
// RelationGenericList is a top level structure for 'other' relationships
...
// PagingLinks type to define links in a JSON-API response
